...
The limit caps what a player can withdraw in a **24-hour window** — it resets daily, and any balance above it carries forward. See [Player Withdrawal Limits](/earn/sdk/user-withdrawal) for reading it from the client.
