...
The limit caps what a player can withdraw in a **24-hour window** — it resets daily, and any balance above it carries forward.
...
Use the `currency` that matches your game's reward model — `POINT` for most games, `MSATS` only if your game is Bitcoin-denominated. See [choosing the right currency](/earn/sdk/withdrawal-limits#choosing-the-right-currency).
