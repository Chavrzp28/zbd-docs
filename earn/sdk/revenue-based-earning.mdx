...
The limit caps what a player can withdraw in a **24-hour window** — it resets daily, and any balance above it carries forward. To read a player's current limit from your game client, see [Player Balance & Limits](/earn/sdk/user-balance); to adjust an individual player's limit by hand, see [Manage Withdrawal Limits](/earn/sdk/manage-withdrawal-limits).
