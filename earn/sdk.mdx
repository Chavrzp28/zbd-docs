...
Before anything else, know what a successful integration depends on. **Three things have to be true for rewards to convert — miss any one and the other two can't save it:**

1. You're **acquiring players who want to earn**. A player with no interest in earning is hard to convert however good the rewards UX is.
2. Your **UI/UX shows and explains** how rewards work and how to claim them — native game elements first, plus creatives and notifications.
3. You're **rewarding enough** to be worth coming back for. Nobody changes their behavior for a few cents; size rewards off actual revenue.
