...
<Steps>
  <Step title="They earn their first reward">
    At a gameplay moment you define (level complete, daily mission chest, milestone hit), a reward notification fires: "You earned 500 coins!" They didn't have to do anything differently — it just happened. Fire this early in the first session, so the player never sees the rewards counter sitting at zero: discovering a balance that already exists is what makes the feature feel real.
  </Step>
  ...
  <Step title="They tap the entry point">
    They tap the counter (or your rewards button). The modal opens instantly — no extra screens. On their very first open, it starts by asking them to create or link their ZBD account (the next step); on every open after that, it goes straight to their balance and payout options.
  </Step>
  <Step title="They link their account">
    First time only. The player creates a ZBD account — this is where they encounter the ZBD brand, briefly, to complete identity verification for cashout. Your game's branding is front and center throughout; ZBD appears only at this cashout step. You can't move this step, but you control when you *prompt* players toward the modal: do it when there's a balance worth claiming, so verification reads as delivering a reward they already own, not as registration.
  </Step>
