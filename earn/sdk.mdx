...
A few decisions should be locked in before you write any code. The reward budget and per-trigger ceilings are adjustable from your server at any time. The daily withdrawal limit and reward currency are much stickier: the withdrawal limit is your most important fraud control and the hardest to change retroactively, and the reward currency is a project-level decision. Set those two correctly from day one.
